...
---
# `=this.file.name`
*Der Biss eines Ghuls kann sein Opfer mit [[_Ghulfieber]] infizieren kann. 
...
Kreaturen, die an [[_Ghulfieber]] erkrankt sind, können für die Dauer dieser [[_Krankheiten|Krankheit]] keine [[Trefferpunkte]] zurückerlangen.  
...
Kreaturen, die sterben, während sie infiziert sind können für die Dauer der [[_Krankheiten|Krankheit]] weder wiederbelebt noch in [[Untote]] verwandelt werden.  
...
Das [[_Ghulfieber]] kann von einer lebenden Kreatur durch [[Schwache Genesung]] oder vergleichbare Magie bzw. Effekte, die [[_Krankheiten]] heilen können, entfernt werden.