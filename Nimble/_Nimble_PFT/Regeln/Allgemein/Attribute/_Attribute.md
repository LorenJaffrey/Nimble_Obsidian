| Attribut         | DSA                   | DnD                   | Daggerheart | Draw Steel   | Nimble          |
| ---------------- | --------------------- | --------------------- | ----------- | ------------ | --------------- |
| Stärke           | Körperkraft (KK)      | Stärke (ST)           | Strength    | Might (M)    | Strength (STR)  |
| Konstitution     | Konstitution (KO)     | Konstitution (KO)     | -           | -            | Strength (STR)  |
| Beweglichkeit    | Gewandheit (GE)       | Geschicklichkeit (GE) | Agility     | Agility (A)  | Dexterity (DEX) |
| Geschick         | Fingerfertigkeit (FF) | Geschicklichkeit (GE) | Agility     | Agility (A)  | Dexterity (DEX) |
| Verstand         | Klugheit (KL)         | Intelligenz (IN)      | Knowledge   | Reason (R)   | Intellect (INT) |
| Wahrnehmung      | Intuition (IN)        | Weisheit (WE)         | Instinct    | Instinct (I) | Willpower (WIL) |
| Entschlossenheit | Mut (MU)              | Weisheit (WE)         | Instinct    | Instinct (I) | Willpower (WIL) |
